package democoding.alamin.com.weatherappdemodgcon;
...
public class MainActivity extends AppCompatActivity {
    ...
    TextView temperature, description, city;
    //The loading Dialog
    ProgressDialog pDialog;
    //We"ll make HTTP request to this URL to retrieve weather conditions
    String weatherWebserviceURL = "http://api.openweathermap.org/data/2.5/weather?q=dhaka,bd&appid=2156e2dd5b92590ab69c0ae1b2d24586&units=metric";
            ...
            JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        // display weather city into the "city textview"
                        city.setText(response.getJSONObject("sys").getString("country"));
                        ...
                        if (jsonObj.getString("main").equals("Clouds")) {
                            ...
                            backgroundImage = "https://upload.wikimedia.org/wikipedia/commons/6/6a/Dhaka_cityscape_sunset.jpg";
                        }
